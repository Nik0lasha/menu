package com.example.whattocook.presentation.adapter
...
import com.example.whattocook.Utill.loadFromUrl
...
class MenuAdapter(val onClick: (Article) -> Unit, val onClickDownload: (String) -> Unit) : RecyclerView.Adapter<MenuAdapter.ArticleViewHolder>() {
